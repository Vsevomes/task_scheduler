# Матрица экспериментов для отчёта
...
| Параметр       | Значения                    |
| -------------- | --------------------------- |
| **tasks**      | **1500**, **9000**, **15000** |
| block-size     | 4096                        |
| total elements | 6.1M / 37M / 61.4M          |
...
| Параметр  | Значения                     |
| --------- | ---------------------------- |
| **tasks** | **3000**, **9000**, **15000** |


### Распределение классов задач


| Класс      | Доля | Размер (элементов) | Пример при 9000 tasks |
| ---------- | ---- | ------------------ | --------------------- |
| **Light**  | 50%  | 2048               | 4500 задач            |
| **Medium** | 30%  | 16384              | 2700 задач            |
| **Heavy**  | 20%  | 65536              | 1800 задач            |
...
| independent   | 100, 1000       | **1500**, **9000**, **15000**  |
| heterogeneous | 300 tasks       | **3000**, **9000**, **15000** |
...
| independent   | 1500, 9000, 15000  | 3      | 9        |
| heterogeneous | 3000, 9000, 15000 | 3      | 9        |
